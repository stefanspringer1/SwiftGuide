...
- some **new language features** might first have to be activated via the ["enableUpcomingFeature" option](https://github.com/apple/swift-evolution/blob/main/proposals/0362-piecemeal-future-features.md) (this is then mentioned o; the according [evolution page](https://github.com/apple/swift-evolution/tree/main/proposals) of the feature)
