...
- None of these systems can handle problems within a program caused by “memory hunger”, overflow aborts because of a high recursion level (stack overflow) or problems in the virtual machine or corresponding problems caused by compiler errors.
