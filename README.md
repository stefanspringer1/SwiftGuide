...
- after an update of Visual Studio it might be necessary to repair the files copied into the Visual Studio installation, using the installed toolchain see [Repair apps and programs in Windows](https://support.microsoft.com/en-us/windows/repair-apps-and-programs-in-windows-e90eefe4-d0a2-7c1b-dd59-949a9030f317)
