...
- on a Mac or iPad, you might also use **Swift Playgrounds** to play around with the language (see [there](https://www.apple.com/de/swift/playgrounds/))
...
- to start the **REPL** ("[Read–eval–print loop](https://en.wikipedia.org/wiki/Read–eval–print_loop)”) under Windows, you need to provide some extra arguments (as of early 2023), cf. https://www.swift.org/getting-started
